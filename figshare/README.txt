...
veps.evaluation.csv : this file contains performance evaluation metrics calculated for all enriched VEPs used in this study for each structural region (disordered,intermediate and ordered)
